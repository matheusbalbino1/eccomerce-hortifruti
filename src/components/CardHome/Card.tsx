...
export function Card(props: Props) {
  ...
  function handleAdicionarCarrinho() {
    ...
    if (carrinhoCompras.find((fruta) => fruta.name === props.fruta.name)) {
      const copiaCarrinhoCompras = carrinhoCompras.map((fruta) => {
    ...
    const copiaFruta = { ...props.fruta, quantidade: 1 };
  ...
  return (
    ...
    >
      ...
      <p>
        {(props.fruta.id * 1.3).toLocaleString("pt-br", {
          style: "currency",
          currency: "BRL",
        })}{" "}
        /kg
